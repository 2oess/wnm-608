...
class Carousel {
	constructor(o) {
		...
		showSlide(direction){
         	...
         	this.slides.eq(this.previouseSlide).addClass("center");
         	if(direction){
         	...
         	setTimeout(function(){
         		...
         		if (direction){
         			c.slides.eq(c.previouseSlide).removeClass("center").addClass("left moving");
         		}else{	
         			c.slides.eq(c.previouseSlide).removeClass("center").addClass("right moving");

...
<head>
    ...
    <base href="http://2oesbag.com/aau/wnm608/zhuoyi.wei/">
	...
	<header class="navbar">
		<div class="container display-flex">
			...
			<ul>
				...
				<li><a href="/aau/wnm608/zhuoyi.wei/admin/users.php">User List</a></li>
				<li><a href="/aau/wnm608/zhuoyi.wei/admin/users.php ?id=new">Add New User</a></li>
			</ul>
	 ...
	 <div class="container">
	 	...
	 	<nav class="nav">
	 		<ul>
	 	<li>
	 			<a href='admin/users.php?id=0'>Zhuoyi Wei</a>
	 		</li><li>
	 			<a href='admin/users.php?id=1'>Amy Yang</a>
	 		</li><li>
	 			<a href='admin/users.php?id=2'>Jenny</a>
	 		</li><li>
	 			<a href='admin/users.php?id=3'>Lily</a>
	 		</li><li>
	 			<a href='admin/users.php?id=4'>Zoe</a>
	 		</li><li>

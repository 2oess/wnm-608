...
<div style="width: 1000px;background: #fff;margin: 0 auto;">
                     ...
                     <div class="card soft">
                        <div style="width:100%;height: 300px;background: #b0b0b0;border-radius: 10px;">
                            <div style="width:50%;float: right;">
                                <h2 style="float:left;margin-left:20px;">Name: <?php echo $v['name'] ?><br>Price: $<?php echo $v['price'] ?><br>Num: <?php echo $v['num'] ?></h2> 
                        ...
                        <br>
                    <?php $total =0;  $total += $v['price']*$v['num']; ?>
            ...
            <div class="col-xs-12 col-md-5">
                <div class="card flat">
                    ...
                    <div class="card-section display-flex">
                        <button  type="button" class="form-button" style="margin-left: 300px;margin-bottom: 20px;"> <p><a href="product_checkout.php"> Checkout</p></button>
